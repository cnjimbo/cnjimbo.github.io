...
![图片](tx-serverless-static\MTYyMTQxNDAwOTUxNg==621414009516)

然后在左上角的云产品列表中找到[云开发CloudBase](https://console.cloud.tencent.com/tcb/env/index?rid=4)

![图片](tx-serverless-static\MTYyMTQxNDA0ODYyNQ==621414048625)

然后你能看到如下的界面

![图片](tx-serverless-static\MTYyMTQxNDI1MDQ0Ng==621414250446)

点击新建，可以看见有很多模板可供选择，咱们这里选择Vue应用，当然你也可以选择其它模板，我们主要是获得其生成的一个`cloudbaserc.json`文件，后文会详细介绍这个配置文件

![图片](tx-serverless-static\MTYyMTQxNDQ2MDk2MA==621414460960)

填写环境名称，选择按量计费（非常非常便宜），勾上**同意**，能勾上免费就勾上**免费资源**

填写完成后点击下一步

![图片](tx-serverless-static\MTYyMTQxNDcyMTMxMw==621414721313)

点击立即开通

![图片](tx-serverless-static\MTYyMTQxNDkzMTczNA==621414931734)

接下来你能在当前页面看到刚刚创建的应用，记住这个环境id 后面会用上

![图片](tx-serverless-static\MTYyMTQxNTA0ODM5OQ==621415048399)
...
![图片](tx-serverless-static\MTYyMTQxNTI1MDkyMg==621415250922)

选择左侧菜单中的静态网站托管

![图片](tx-serverless-static\MTYyMTQxNTQ4MTgyMA==621415481820)
...
node -v
```
![图片](tx-serverless-static\MTYyMTQxNzk1NjM2Nw==621417956367)
...
tcb -v
```
![图片](tx-serverless-static\MTYyMTQxODE1NzQxMw==621418157413)
...
![图片](tx-serverless-static\MTYyMTQxODQ3NzM2Ng==621418477366)
...
![图片](tx-serverless-static\MTYyMTQxODUzNDcyNA==621418534724)
...
![图片](tx-serverless-static\MTYyMTQyNzUyMDQwNg==621427520406)

选择免费的

![图片](tx-serverless-static\MTYyMTQyNzYyMTYxOQ==621427621619)

然后下一步填写必要的信息

![图片](tx-serverless-static\MTYyMTQyNzY5MjI0NA==621427692244)

选择DNS验证

![图片](tx-serverless-static\MTYyMTQyNzczMDM5OA==621427730398)

按要求添加一条解析规则

![图片](tx-serverless-static\MTYyMTQyNzc3ODgwNg==621427778806)

我这里域名是在阿里云上购买的

![图片](tx-serverless-static\MTYyMTQyNzgxNDgzMQ==621427814831)

按要求添加解析

![图片](tx-serverless-static\MTYyMTQyODAxNzQxNg==621428017416)

添加完成后，点击查询域名验证状态即可，申请完成后如下图所示

![图片](tx-serverless-static\MTYyMTQyODI0ODg5NQ==621428248895)

### 绑定域名

在静态网站托管tab 基础配置中添加自定义域名

![图片](tx-serverless-static\MTYyMTQyNzM0MTE5Nw==621427341197)

弹窗中输入刚刚申请证书用的域名

![图片](tx-serverless-static\MTYyMTQyODQ2MDgxOA==621428460818)

根据要求添加CName

![图片](tx-serverless-static\MTYyMTQyODUxNDM5NQ==621428514395)

上述添加解析步骤一样

![图片](tx-serverless-static\MTYyMTQyODYyNzgwMw==621428627803)
...
![图片](tx-serverless-static\MTYyMTQxODczMjA4OQ==621418732089)
...
![图片](tx-serverless-static\MTYyMTQxOTM0MzkxNg==621419343916)

![图片](tx-serverless-static\MTYyMTQxOTU0NTUzMQ==621419545531)
...
![图片](tx-serverless-static\MTYyMTQxOTcxMjA5NA==621419712094)

添加完成后如下图所示

![图片](tx-serverless-static\MTYyMTQxOTkyNDM5MA==621419924390)
...
![图片](tx-serverless-static\MTYyMTQyMDI5MDY4NQ==621420290685)

在Action面板中也能看见任务的执行状态，点击可查看详细进度

![图片](tx-serverless-static\MTYyMTQyMDM1MjExNQ==621420352115)

执行完成后如下图所示

![图片](tx-serverless-static\MTYyMTQyNjI3MjYzNg==621426272636)
## 参考资料
