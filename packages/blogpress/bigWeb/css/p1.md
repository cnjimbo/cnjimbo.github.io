...
## 示例
### 1.指定文本前后添加内容
![图片](p1\MTU3OTYxMzk2Nzc5MQ==579613967791)
```html
...
### 2.展示指定元素的指定属性内容
![图片](p1\MTU4MjExNjI1Mzg0OQ==582116253849)
```html
...
### 3.附加图片icon
![图片](p1\MTU4MjExNzE5MjM3Ng==582117192376)
```html
<i class="icon"></i>
```
```css
...
![图片](p1\MTU3OTYxNDYyMjQ1MA==579614622450)
...
![图片](p1\MTU3OTY5ODc2MzUyNw==579698763527)
```html
<div class="code">
    content
</div>
...
![图片](p1\MTU3OTY5ODk0MjY3MA==579698942670)
...
![图片](p1\MTU3OTY5OTE2Nzc5OQ==579699167799)
...
![图片](p1\MTU3OTY5OTQwOTYxMQ==579699409611)
